        ...
        <div className='container border-top mt-5'>
            <div className='row mt-5'>
                <div className='col'>
                    ...
                    <p className='fs-6 mt-3'> © 2010 - 2026, Zerodha Broking Ltd.
           All rights reserved.</p>
                </div>
                    <div className='col'>
                        <p className='fact'>Company</p>                     
                        <ul>
                   ...
                   <div className='col '>
                    ...
                    <div className='col'>
                        <p className='fact'>Quick links</p>
            ...
            <div className='fs-7 mt-2 font text-muted'>
                <p>
